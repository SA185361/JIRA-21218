...
DROP Table if exists vision.##CONTACT2
...
Declare @LINK int;
Select @LINK = max(link) + 1 from  vision.CONTACT 
print @LINK

SET @sql = '
CREATE TABLE vision.##CONTACT2(

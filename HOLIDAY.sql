...
DROP Table if exists vision.##HOLIDAY2
...
Declare @LINK int;
Select @LINK = max(link) + 1 from  vision.HOLIDAY 
print @LINK

SET @sql = '
CREATE TABLE vision.##HOLIDAY2(
